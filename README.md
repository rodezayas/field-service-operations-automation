...
Field technicians, dispatchers, and operational leaders were coordinating work order execution manually across WhatsApp, internal systems, and Zoho FSM.
...
I designed and implemented the workflow architecture, API integrations, WhatsApp interaction logic, AI and human evidence-validation paths, Zoho FSM synchronization, internal system updates, error handling, and final report distribution.
